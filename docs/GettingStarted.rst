...
Installation
------------
You can **install EoN version 1.92** with pip
...
recent version available through pip (1.92).  The easiest way is 
...
The documentation provided here is for version 1.92.
