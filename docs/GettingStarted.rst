...
Installation
------------
You can **install EoN version 1.91** with pip
...
recent version available through pip (1.91).  The easiest way is 
...
The documentation provided here is for version 1.91.
