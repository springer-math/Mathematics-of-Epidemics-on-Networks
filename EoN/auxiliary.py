...
def node_status(node, node_history, time):
    r'''
    ...
    Arguments :
        ...
        node 
            the node
        node_history 
            the node_history returned by one of the EoN simulations with return_full_data=True
        time (float)
...
def get_statuses(nodelist, node_history, time):
    r'''
